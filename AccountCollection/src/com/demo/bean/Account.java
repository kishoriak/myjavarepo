...
public abstract class Account {
	...
	//Acc Id will be considered as hashcode
	@Override
	public int hashCode() {
    	System.out.println("hash code in account");
    	return accId.hashCode();
	}
	//equals for comparing id of 2 objects
	@Override
	public boolean equals(Object obj) {
		System.out.println("equals in account"+this.accId+"----"+((Account)obj).accId);
	    if(this.accId.equals(((Account)obj).accId))
	    	return true;
	    return false;
	}
	
	//to display data of the Account
	@Override
